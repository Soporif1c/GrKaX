...
/**
 * Mirrors the Android model field for field — the parsers and the config
 * builder are shared logic, and keeping the shape identical means a profile
 * exported from one client can be read by the other.
 */
@Serializable
data class Profile(
